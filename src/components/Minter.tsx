...
export default function Minter({time, out}: {time: number, out: boolean}) {
	...
	return (
		<div className="flex flex-col items-center justify-center w-80 md:w-96">
			...
			<div className="flex flex-col items-center justify-center py-4 self-center">
			...
			<div className="flex flex-col justify-start items-start">
				...
				{isMismatched && <div className="flex flex-col items-center justify-center py-4 self-center">
					<button  
				...
				{!minted && !claimed && time<=0 && !out && !isMismatched && !isClaiming && <div className="flex flex-col items-center justify-center py-4 self-center">
					<p className="flex flex-col items-center justify-center self-center text-md text-center mt-2">You may claim {evaluate(-time)}.</p>
					<button 
				...
				{!isMismatched && (isClaiming || isMinting) && <div className="flex flex-col items-center justify-center py-4 self-center">
					<Loader/>
				</div>}	
				
				{minted && claimed && !newMint && !isMismatched && <div className="flex flex-col items-center justify-center py-4 self-center">
				<div className="flex flex-row items-center justify-center px-2 self-center">
