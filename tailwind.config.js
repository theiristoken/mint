    ...
    extend: {
      keyframes: {
        ...
        headShake: {
          ...
          '6.5%': {
            transform: 'translateX(-15px) translateY(-15px) rotateY(-9deg)',
          },

          '18.5%': {
            transform: 'translateX(15px) translateY(15px)  rotateY(7deg)',
          },

          '31.5%': {
            transform: 'translateX(-9px) translateY(9px)  rotateY(-5deg)',
          },

          '43.5%': {
            transform: 'translateX(5px) translateY(-9px)  rotateY(3deg)',
          },
          '50%': {
            transform: 'translateX(0)',
          },
